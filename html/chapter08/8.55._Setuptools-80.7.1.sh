...
srcdir=../../src/setuptools-80.7.1
tar xf ../../src/setuptools-80.7.1.tar.gz -C ../../src
...
#  Installed directory: /usr/lib/python3.13/site-packages/_distutils_hack, /usr/lib/python3.13/site-packages/pkg_resources, /usr/lib/python3.13/site-packages/setuptools, and /usr/lib/python3.13/site-packages/setuptools-80.7.1.dist-info
cd $topdir
rm -rf $srcdir
